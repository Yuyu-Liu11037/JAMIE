...
adata = ad.read_h5ad('/workspace/JAMIE/data/multiome_processed.h5ad')
...
adata.write_h5ad("/workspace/JAMIE/data/multiome_preprocessed.h5ad")

X_GEX = adata_GEX.X.toarray()
X_GEX[SITE1_CELL + SITE2_CELL: SITE1_CELL + SITE2_CELL + SITE3_CELL] = 0
adata_GEX.X = csr_matrix(X_GEX)

adata_GEX.write_h5ad('/workspace/JAMIE/data/multiome_missing_gex.h5ad')
adata_ATAC.write_h5ad('/workspace/JAMIE/data/multiome_missing_atac.h5ad')